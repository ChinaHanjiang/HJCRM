...
public class DataUtil {
	...
	public static List<TaskDto> convertTaskToDto(List<Task> ts) {
		...
		if(ts!=null){
			...
			while(it.hasNext()){
				...
				td.setTaskType(t.getTaskType()==null?"":t.getTaskType().getName());
				td.setTaskTypeId(t.getTaskType()==null?0:t.getTaskType().getId());
				td.setCustomer(t.getCustomer()==null?"":t.getCustomer().getName());
				td.setCustomerId(t.getCustomer()==null?0:t.getCustomer().getId());
				td.setCreateUser(t.getCreateUser()==null?"":t.getCreateUser().getName());
				td.setCreateUserId(t.getCreateUser()==null?0:t.getCreateUser().getId());
				td.setCreateTime(t.getCreateTime() == null ? "" : sdf_dt
						.format(t.getCreateTime()));
				td.setUpdateUser(t.getUpdateUser()==null?"":t.getUpdateUser().getName());
				td.setUpdateUserId(t.getUpdateUser()==null?0:t.getUpdateUser().getId());
	...
	private static List<ComboResultDto> convertCustomersToCrds(List<Customer> cls) {
